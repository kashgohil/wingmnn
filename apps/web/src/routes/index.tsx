  ...
  return (
    <section className="flex flex-col gap-12 text-center">
      ...
      <div className="flex flex-wrap items-center justify-center gap-4">
        <Button className="flex items-center gap-2" type="button" size="lg">
          Start with email
          <ArrowRight className="h-4 w-4" />
        </Button>
        <Button className="" type="button" variant="outline" size="lg">
          See platform tour
        </Button>
      </div>
    </section>
    ...
    <section className="space-y-16">
      ...
      <div className="space-y-16">
        {modules.map((module, index) => (
          <ModuleSection key={module.name} module={module} index={index} />
        ))}
      </div>
    </section>
  );
    ...
    <section className="space-y-12">
      ...
      <div className="text-center">
        <Button variant="outline" type="button" asChild>
          <Link to="/integrations" className="inline-flex items-center gap-2">
