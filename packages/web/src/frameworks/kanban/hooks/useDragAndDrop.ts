...
export function useDragAndDrop({ onCardMove }: UseDragAndDropProps) {
	...
	const handlePointerDown = useCallback((e: React.PointerEvent, cardId: string, sourceColumnId: string) => {
		e.preventDefault();
	...
	const handlePointerUp = useCallback(
		(e: React.PointerEvent) => {
			...
			if (dragState.draggedCardId && dragState.sourceColumnId && dragState.targetColumnId !== null) {
				onCardMove(
