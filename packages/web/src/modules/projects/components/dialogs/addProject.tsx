            ...
            {map(workflows || [], ({ id, name, description }) => (
              ...
              >
                <div
                  ...
                  className="h-full flex flex-col text-left transition-all justify-between rounded-lg cursor-pointer overflow-hidden min-w-64 max-w-64 relative"
                >
                  ...
                  <div className="p-4 bg-accent/20 overflow-hidden">
                    <Typography.Paragraph className="text-accent font-semibold">
                      {name}
                    </Typography.Paragraph>
                    <Typography.Caption
                      id={`workflow-${id}-description`}
                      className="text-white-950 whitespace-pre-wrap w-full"
                    >
                      {description}
                    </Typography.Caption>
                  </div>
