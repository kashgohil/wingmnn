...
describe("catchError", () => {
	test("should return [result, null] for successful promises", async () => {
	...
	test("should return [null, error] for rejected promises", async () => {
	...
	test("should convert non-Error rejections to Error", async () => {
...
describe("catchErrorSync", () => {
	test("should return [result, null] for successful functions", () => {
		const fn = () => "success";
	...
	test("should return [null, error] for throwing functions", () => {
		const fn = () => {
	...
	test("should convert non-Error throws to Error", () => {
		const fn = () => {
			throw "string error";
		};
		const [result, error] = catchErrorSync(fn);
...
describe("isError", () => {
	test("should return true for error results", async () => {
		const promise = Promise.reject(new Error("failed"));
	...
	test("should return false for success results", async () => {
		const promise = Promise.resolve("success");
		const result = await catchError(promise);
...
describe("isSuccess", () => {
	test("should return true for success results", async () => {
		const promise = Promise.resolve("success");
		const result = await catchError(promise);
	...
	test("should return false for error results", async () => {
		const promise = Promise.reject(new Error("failed"));
		const result = await catchError(promise);
...
describe("real-world usage examples", () => {
	...
	test("should work with async/await chains", async () => {
